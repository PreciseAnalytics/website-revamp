...
const SERVICES: Service[] = [
  ...
  { id: 'custom-solutions',      title: 'Custom Analytics Solutions',        description: "When off-the-shelf tools don't fit, we build secure, scalable analytics apps tailored to mission-critical workflows.",                                                              category: 'ai',            outcomes: ['Purpose-built tools',          'Secure, compliant deployments',   'Mission-critical performance'     ] },
